...
const RecommendUsersCard = ({ recUser }) => {
  ...
  const followHandler = () => {
    if(!userId){
      ...
      try {
        axios
          .put("https://superfam-backend-production.up.railway.app/api/user/" + recUser._id + "/follow", { userId: userId })
          .then((res) => {
            toast({
              title: res.data,
              status:"success" ,
  ...
  const unfollowHandler = () => {
    if(!userId){
      ...
      try {
        axios
          .put("https://superfam-backend-production.up.railway.app/api/user/" + recUser._id + "/unfollow", { userId: userId })
          .then((res) => {
            toast({
              title: res.data,
              status:"success" ,
